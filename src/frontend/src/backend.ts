...
import type { ContentCollection as _ContentCollection, ContentMetadata as _ContentMetadata, ExternalBlob as _ExternalBlob, Setting as _Setting, StaffProfile as _StaffProfile, Time as _Time, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async deleteSetting(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteSetting(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPublishedStaff(): Promise<Array<StaffProfile>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllPublishedStaff();
    ...
    async getAnnouncementsByPublished(arg0: boolean): Promise<Array<Announcement>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAnnouncementsByPublished(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getContentMetadata(arg0: ContentCollection, arg1: string | null): Promise<ContentMetadata | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getContentMetadata(to_candid_ContentCollection_n16(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n18(this._uploadFile, this._downloadFile, arg1));
    ...
    async getPublishedGalleryEntries(): Promise<Array<[string, ExternalBlob]>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublishedGalleryEntries();
    ...
    async getStaffProfile(arg0: string): Promise<StaffProfile> {
        if (this.processError) {
            try {
                const result = await this.actor.getStaffProfile(arg0);
                return from_candid_StaffProfile_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async publishFiles(arg0: Array<string>): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.publishFiles(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveAnnouncement(arg0: Announcement): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveAnnouncement(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveEvent(arg0: Event): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveEvent(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveSetting(arg0: Setting): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveSetting(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async saveStaffProfile(arg0: StaffProfile): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.saveStaffProfile(to_candid_StaffProfile_n28(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ContentCollection_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ContentCollection): ContentCollection {
    return from_candid_variant_n23(_uploadFile, _downloadFile, value);
}
function from_candid_ContentMetadata_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ContentMetadata): ContentMetadata {
...
function from_candid_StaffProfile_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _StaffProfile): StaffProfile {
...
function from_candid_opt_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_ContentMetadata]): ContentMetadata | null {
    return value.length === 0 ? null : from_candid_ContentMetadata_n20(_uploadFile, _downloadFile, value[0]);
}
function from_candid_opt_n27(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Setting]): Setting | null {
    return value.length === 0 ? null : value[0];
}
...
function from_candid_record_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        photoId: record_opt_to_undefined(from_candid_opt_n13(_uploadFile, _downloadFile, value.photoId))
    };
}
function from_candid_record_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    id: string;
    contentType: _ContentCollection;
    lastModified: _Time;
    collectionUpdated: _Time;
    collectionSize: bigint;
}): {
    id: string;
    contentType: ContentCollection;
    ...
    return {
        id: value.id,
        contentType: from_candid_ContentCollection_n22(_uploadFile, _downloadFile, value.contentType),
        lastModified: value.lastModified,
        collectionUpdated: value.collectionUpdated,
        collectionSize: value.collectionSize
    };
}
...
async function from_candid_tuple_n25(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [string, _ExternalBlob]): Promise<[string, ExternalBlob]> {
    return [
        value[0],
        await from_candid_ExternalBlob_n26(_uploadFile, _downloadFile, value[1])
    ];
}
...
function from_candid_variant_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "siteSettings" in value ? ContentCollection.siteSettings : "staff" in value ? ContentCollection.staff : "events" in value ? ContentCollection.events : "announcements" in value ? ContentCollection.announcements : "gallery" in value ? ContentCollection.gallery : value;
}
function from_candid_vec_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_StaffProfile>): Array<StaffProfile> {
    return value.map((x)=>from_candid_StaffProfile_n11(_uploadFile, _downloadFile, x));
}
...
function to_candid_ContentCollection_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ContentCollection): _ContentCollection {
    return to_candid_variant_n17(_uploadFile, _downloadFile, value);
}
function to_candid_StaffProfile_n28(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: StaffProfile): _StaffProfile {
...
function to_candid_variant_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ContentCollection): {
    siteSettings: null;
} | {
    staff: null;
} | {
    ...
    return value == ContentCollection.siteSettings ? {
        siteSettings: null
    } : value == ContentCollection.staff ? {
        staff: null
    } : value == ContentCollection.events ? {
        events: null
    } : value == ContentCollection.announcements ? {
        announcements: null
    } : value == ContentCollection.gallery ? {
        gallery: null
    } : value;
}
